...
const sessions = new Map(); // tgUserId -> sessionId
...
bot.on("contact", async (ctx) => {
  ...
  const siteUrl = process.env.SITE_URL; // например https://jumaboevx.netlify.app
  const backUrl = `${siteUrl}/verify?sessionId=${sessionId}`;
